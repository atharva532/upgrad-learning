...
Quality gates to verify work at different stages.
...
> [!IMPORTANT]
> The `validation.md` checklist includes AI-specific checks for hallucinated imports and should be used for all AI-assisted code generation.
